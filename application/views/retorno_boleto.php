<?php
    if ($transacao->transacao->erro) {
        ...
        heading("Código do erro: " . $transacao->transacao->erro->codigo, 4) . heading("Mensagem da operadora: " .
        $transacao->transacao->erro->mensagem, 4) . "</div>" . "</div>";
    } else {
         echo "<div class='row-fluid'>" .
        "<div class=span12>" .
		...
		heading("Status: " . ucfirst(str_replace("-"," ", $transacao->transacao->status)),5) . 
